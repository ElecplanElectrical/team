...
export const EVENT_COLOR: Record<string,{ bg:string;border:string;fg:string }> = {
  ...
  "job-scheduled":{bg:"rgba(61,197,240,0.22)",border:COLORS.accent,fg:"#BFEBFA"},
  "job-in-progress":{bg:"rgba(240,178,61,0.22)",border:COLORS.amber,fg:"#FBE3B8"},
  "job-complete":{bg:"rgba(51,214,172,0.22)",border:COLORS.teal,fg:"#B9F5E4"},
