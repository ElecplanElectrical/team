...
export default async function manifest(): Promise<MetadataRoute.Manifest> {
  ...
  if(host==="qls.your-plan.com.au")return {name:"Quality Landscape Solutions Team Portal",short_name:"QLS Portal",description:"Private Quality Landscape Solutions team portal.",start_url:"/dashboard",display:"standalone",background_color:"#040605",theme_color:"#040605",icons:[{src:"/qls-apple-touch-icon.png?v=4",sizes:"180x180",type:"image/png",purpose:"any"}]};
