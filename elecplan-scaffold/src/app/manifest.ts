...
export default async function manifest(): Promise<MetadataRoute.Manifest> {
  ...
  return { name: BRAND.name, short_name: BRAND.shortName, description: BRAND.description, start_url: "/", display: "standalone", background_color: BRAND.background, theme_color: BRAND.background, icons:[{src:"/yourplan-app-icon.svg",sizes:"any",type:"image/svg+xml",purpose:"any maskable"}] };
}
