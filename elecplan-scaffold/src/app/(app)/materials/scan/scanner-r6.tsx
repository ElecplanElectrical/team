...
export default function ScannerR10(){
  ...
  return <div className="min-h-screen bg-[#0d1117] p-4 text-white"><div className="mx-auto max-w-xl space-y-4">
    <div className="flex items-center justify-between"><Link href="/materials" className="flex items-center gap-2 text-sm text-[#c5cdd7]"><ArrowLeft size={16}/> Materials</Link><span className="text-[11px] text-[#a5b0bd]">{BUILD}</span></div>
    <h1 className="text-3xl font-semibold">Scan Stock</h1>
    <div className="overflow-hidden rounded-2xl border border-[#43D2FF55] bg-[#181e27]"><div className="relative aspect-[4/3] overflow-hidden bg-black">
