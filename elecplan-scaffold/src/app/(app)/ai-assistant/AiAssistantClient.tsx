...
export default function AiAssistantClient(){
 ...
 return <div className={styles.page}><div className={styles.wrap}>
  <header className={styles.head}><h1><span>EP</span> Assistant</h1><p>Your jobs, notes and admin — just tell me.</p></header>
  <section className={styles.hero}>
   ...
   <strong>{listening?"Listening… release to finish":"Press and hold to speak"}</strong><small>Speak naturally — I’ll listen, understand and take action.</small>
  </section>
  ...
  <div className={styles.actions}><button type="button" onClick={()=>camera.current?.click()}><Camera/><span>Double tap<br/>to take a photo</span></button><button type="button" onClick={()=>library.current?.click()}><ImagePlus/><span>Tap to choose<br/>from library</span></button></div>
