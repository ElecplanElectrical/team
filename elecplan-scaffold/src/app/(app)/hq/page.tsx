...
export default async function HqPage(){
 ...
 return <><TopBar title="Your Plan HQ" subtitle="Platform overview"/><main className="flex-1 overflow-auto p-4 md:p-6" style={{background:"var(--app-bg, #03101f)"}}><div className="mx-auto max-w-7xl space-y-4">
  ...
  <section className="grid gap-3 sm:grid-cols-2 xl:grid-cols-5"><Quick href="/hq/customers" title="Customers" text="Customer records and account details"/><Quick href="/hq/portals" title="Customer Portals" text="Open and configure each business portal"/><Quick href="/hq/templates" title="Portal Templates" text="Reusable industry starting points"/><Quick href="/hq/subscriptions" title="Subscriptions" text="Plans, status and recurring billing"/><Quick href="/hq/users" title="Users & Access" text="Customer admins and portal access"/></section>
