  ...
  return <>
    ...
    <div className="flex-1 overflow-auto p-3 md:p-4 xl:p-5" style={{ background: "var(--ep-main)" }}>
      <div className="mx-auto w-full max-w-[1700px] space-y-3">
        ...
        <div className="rounded-xl px-4 py-3 text-xs leading-5" style={{ ...UI.raised, background: UI.panel, border: `1px solid ${UI.border}`, color: UI.mute }}><span className="mr-2 inline-flex align-middle" style={{ color: UI.cyan }}><ShieldCheck size={15} /></span>Secret values and message bodies are intentionally excluded from audit metadata.</div>
