...
export default async function ProjectsPage() {
  ...
  return <ProjectsView photos={photos.map((photo) => ({ id: photo.id, fileUrl: photo.fileUrl, uploadedAt: photo.uploadedAt.toISOString(), job: photo.job.title, address: photo.job.address, client: photo.job.client.name }))} jobs={jobs} />;
}
