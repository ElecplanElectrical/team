...
const UI = { panel: "#0a2038", panelAlt: "#103152", border: "rgba(125,211,252,.28)", borderSoft: "rgba(125,211,252,.14)", text: "#f5f9ff", mute: "#a8c3dd", faint: "#7392af", blue: "#38bdf8", cyan: "#7dd3fc", orange: "#ffb454", red: "#ff7185" };
...
export default function ReviewsView({ reviews, clients }: { reviews: ReviewRow[]; clients: ClientOption[] }) {
  ...
  return <>
    <TopBar title="Reviews" subtitle="Track client reputation and feedback" rightSlot={<button type="button" onClick={() => setShowNew(true)} className="flex h-10 items-center gap-2 rounded-lg px-3.5 text-sm font-semibold" style={{ background: UI.blue, color: "#06213a" }}><Plus size={16} /> Add review</button>} />
    <div className="flex-1 overflow-auto p-3 md:p-4 xl:p-5" style={{ background: "radial-gradient(circle at 55% 0%,rgba(56,189,248,.14),transparent 38%),#061525" }}><div className="mx-auto w-full max-w-[1700px] space-y-3">
