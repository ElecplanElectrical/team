...
const STATUS_STYLE: Record<BillStatus, { bg: string; fg: string; border: string }> = {
  UNPAID: { bg: "rgba(67,210,255,.12)", fg: "#78e5ff", border: "rgba(67,210,255,.30)" },
