...
export default function ProjectsView({ photos, jobs, canDelete }: { photos: ProjectPhoto[]; jobs: { id: string; title: string }[]; canDelete: boolean }) {
